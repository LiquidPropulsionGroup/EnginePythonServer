    ...
    while True:
        ...
        if STORING:
            ...
            for sensor_reading in data:
                ...
                insert_string = f""" INSERT INTO 'new_db' (PT_HE, PT_Purge, PT_Pneu, PT_FUEL_PV, PT_LOX_PV, PT_CHAM, TC_FUEL_PV, TC_LOX_PV, TC_LOX_Valve_Main, TC_WATER_In, TC_WATER_Out, FT_Thrust) VALUES 
                ( {sensor_timestamp[0]},
